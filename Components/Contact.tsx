  ...
  return (
    <div className="max-w-7xl lg:mx-auto space-y-5 px-4" id="contact">
        ...
        <div className=" max-w-xl flex flex-wrap justify-start gap-6">
            ...
            <Link href="https://www.tiktok.com/@alienrealtor?_t=8mwwrFkOW4D&_r=1" className="max-w-[220px] flex justify-start items-center space-x-3 text-[#2E2E2E] text-base font-semibold">
            ...
            <Link href="https://www.instagram.com/alienrealtor?igsh=cWxmZHcxem16cGh6&utm_source=qr" className="max-w-[230px] flex justify-start items-center space-x-3 text-[#2E2E2E] text-base font-semibold">
